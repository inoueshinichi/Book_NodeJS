...
// ○ 読み込みストリーム => asyncIterable
// x asyncIterable => 読み込みストリーム

////////////////////////////////////////////////////////////////////////
// stream.Readable.from()でasyncIterableから読み込みストリームを作成できる
////////////////////////////////////////////////////////////////////////
// asyncジェネレータ関数
...
;(async () => {
    try {
        await pipeline(
            asyncGenerator(), // 直接AsyncIterableを指定できる
            fs.createWriteStream('./data/write.txt'),
        )
    } catch (err) {
