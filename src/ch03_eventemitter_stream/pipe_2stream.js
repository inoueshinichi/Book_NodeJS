...
const srcReadStream = new fs.createReadStream('./data/src.txt')
srcReadStream
    .pipe(fs.createWriteStream('./data/dst1_no_crypt.txt'))
    .on('finish', () => console.log('分岐1完了'))

srcReadStream
    .pipe(crypto.createHash('sha256'))
    .pipe(fs.createWriteStream('./data/dst2_yes_crypt.txt'))
